 ...
 * @author Willy_Pc32
 */
@WebServlet(name = "PruebaAPI", urlPatterns = {"/pruebaw"})
public class PruebaAPI extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(PruebaAPI.class.getName());
