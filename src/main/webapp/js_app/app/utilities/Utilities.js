function getDefaultOptionsPagination() {
    ...
    var defaultOptions = {
        ...
        first: "<i class='fa fa-angle-double-left' arial-hidden='true'></i>",
        prev: "<i class='fa fa-angle-left' arial-hidden='true'></i>",
        next: "<i class='fa fa-angle-right' arial-hidden='true'></i>",
