...
<html class="no-js" lang="es">
    ...
    <body>
        ...
        <div class="page-container">
             ...
             <!-- SE AGREGA EL MENU DE LA DERECHA-->
            ...
            <div class="sidebar-menu">
                <div class="sidebar-header">
                    ...
                    <br>
                    <h6 class="text-center" style="color: aliceblue"><i class="fa fa-user"></i> <strong>Willy</strong></h6>
                </div>
                ...
                <div class="main-content-inner" style="padding-top: 30px">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 id="nameCrudCategoria" class="card-title">CATEGORIAS</h5>
                                    <!--input como almacenas cosas pra mandarlos a llamar por ajax-->
                                    <input type="hidden" id="nameFormCategoria" value="FrmCategoria">
                                    <input type="hidden" id="actionCategoria" name="action" value="paginarCategoria"> <!--es elq ue se v air al SERVLET-->
                                    <input type="hidden" id="numberPageCategoria" name="numberPageCategoria" value="1"> <!-- pra paginar las categorios yempieze en 1-->
            ...
            <!--EMPIEZA EL MODAL PAR AGREGAR CATEGORIA-->
                    ...
                    <div class="modal-content">
                        <form id="FrmCategoriaModal">
                            <div class="modal-header">
                                <h6 class="modal-title" id="tituloModalManCategoria"></h6> <!--este id le cambiaremos su shtml para que muestre un titulo en el modal se ara en js-->
